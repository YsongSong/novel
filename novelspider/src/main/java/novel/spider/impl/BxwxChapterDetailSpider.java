 ...
 */
public class BxwxChapterDetailSpider extends AbstractChapterDetailSpider {
...
//            detail.setPrev(doc.select(splits[0]).get(Integer.parseInt(splits[1])).absUrl("href"));
            ...
            detail.setPrev(baseUrl.replace("index.html", "") + prev);
...
//            detail.setNext(doc.select(splits[0]).get(Integer.parseInt(splits[1])).absUrl("href"));
            ...
            detail.setNext(baseUrl.replace("index.html", "") + next);
